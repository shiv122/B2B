...
<?php 
                                    ...
                                    <tr class="">
                                        ...
                                        <td>
                                            <a href="profile_control.php?id=<?php echo $row["order_id"]; ?>&name=order_appr" class="btn-fab btn-fab-sm btn-success shadow text-white"><i class="icon-done_all"></i></a> &nbsp; &nbsp;
                                            <a href="profile_control.php?id=<?php echo $row["order_id"]; ?>&name=order_rej" class="btn-fab btn-fab-sm btn-danger shadow text-white"><i class="icon-highlight_off"></i></a>&nbsp; &nbsp;
                                            <?php if ($row['dispatched']=='0') {
                                                # code...
                                            ?>
                                            <a href="inc/disp.php?id=<?php echo $row["order_id"]; ?>&name=dispatched" class="btn-fab btn-fab-sm btn-info shadow text-white"><i class="icon-truck"></i></a>
                                        <?php  }?>
                                        </td>
<?php } } ?>
                                    </tr>
