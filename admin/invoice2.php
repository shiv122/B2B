...
<?php 
  ...
  $rest = mysqli_query($conn ,$query);
    if (mysqli_num_rows($rest) > 0)
                                        ...
                                        $sql="SELECT * FROM orders where product_id='".$rowm['id']."' ";
                                    ...
                                    <tr class="">
                                        ...
                                        <td>
                                            <a href="seller_invoice.php?id=<?php echo $row["order_id"]; ?>&name=order_appr" class="btn-fab btn-fab-sm btn-success shadow text-white"><i class="icon-list-alt"></i></a> &nbsp; &nbsp;
