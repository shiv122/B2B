...
<div class="page has-sidebar-left">
        ...
        <div class="container-fluid text-white">
            ...
            <div class="row">
                <ul class="nav responsive-tab nav-material nav-material-white">
                    ...
                    <li>
                        <a class="nav-link active" href="add_catagory.php"><i
    ...
    <div class="container-fluid animatedParent animateOnce my-3">
        <div class="animated fadeInUpShort">
            <form id="needs-validation" novalidate action="add_cat.php" method="POST" enctype="multipart/form-data">
                <div class="row">
                    
                        
                            <div class="col-6">
                                <label for="validationCustom01">Category Name</label>
                                <input required type="text" class="form-control" name="cata" id="validationCustom01"
                                       placeholder="catagory"  required>
                                       <input required type="text" hidden class="form-control" name="by" id="validationCustom01"
                                       placeholder="catagory"   value="0"> &nbsp; &nbsp;
