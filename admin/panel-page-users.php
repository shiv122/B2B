...
<div class="page  has-sidebar-left height-full" >
                        ...
                        <div class="card r-0 shadow">
                            <div class="table-responsive">
                               ...
                               data-options='{ "paging": false; "searching":false}'>
                                        ...
                                        <tbody>
                                            <?php 
                                        $sql="SELECT username,password,name,item,income,phone,status,role,id,image FROM users where u_status=1";
  ...
  width: 150px;" class="user_avatar" src="<?php echo $row['image']; ?>" alt="User Image">
                                            ...
                                            <td><span class="icon icon-circle s-12  mr-2 text-<?php switch ($row['status']) {
                                                case '0':
                                                    echo "warning";
                                                    break;
                                                case '1':
...
<a class="s-20  icon-pencil btn-fab shadow btn-info" href="profile_control.php?id=<?php echo $row["id"]; ?>&name=edit"></a> &nbsp; &nbsp;
<a  class="s-20 icon-eye btn-fab shadow btn-success" href="profile_control.php?id=<?php echo $row["id"]; ?>&name=view"></a> &nbsp; &nbsp;
<a <?php if ($row['role'] == '1'){ ?> hidden <?php   } ?>  class="s-20 icon-delete_forever btn-fab shadow btn-danger" href="profile_control.php?id=<?php echo $row["id"]; ?>&name=delete"></a>
