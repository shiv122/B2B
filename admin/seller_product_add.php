        ...
        <div class="container-fluid text-white">
            ...
            <div class="row">
                <ul class="nav responsive-tab nav-material nav-material-white">
                    <li>
                        <a class="nav-link" href="#"><i class="icon icon-plus"></i>Add Product</a>
                    </li>
                    ...
                    <div class="col-md-8 ">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-4">
                                  ...
                                  <input type="number" name="qt" class="form-control" id="validationCustom02" placeholder="Quantity" value="" required>
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <?php
                                    ...
                                    $sql="SELECT id,name from catagory WHERE id='".$_SESSION['cat']."' AND cat_status=1";
...
if (mysqli_num_rows($result) > 0) {
   ...
   $row = mysqli_fetch_assoc($result);
                      ...
                      <input name="" type="text" readonly class="form-control" id="" placeholder="<?php echo $row['name']; ?>" value="<?php echo $row['name']; ?>">
                      <input type="text"  hidden name="catagory" value="<?php echo $_SESSION['cat']; ?>">
                              ...
                              <div class="col-md-3 mb-3">
                                ...
                                <select onchange ="cat(this.value)" name="sub" id="sub" class="custom-select form-control" required>
 ...
 <?php
                                    ...
                                    $sql="SELECT * from sub_category WHERE parent='".$_SESSION['cat']."' ";
                                    $result = mysqli_query($conn , $sql);
if (mysqli_num_rows($result) > 0) {
             ...
             success: function(data){
               ...
               $("#pub").removeAttr("disabled");
                    ...
                    <div class="col-md-3">
                        ...
                        <input class=  "col-md-6 mb-3" id=  "file-upload" name=  "photo"  onchange="enable();" type=  "file" multiple />
                        <br>
...
<a onclick="add_row()" id="b" hidden class="btn-fab btn-fab-sm shadow btn-primary"><i class="icon-plus"></i></a>
<br>
  ...
  <br>
   ...
   }' ><br><label for="tags" >Blocked Zip</label>
  <br>
                                         
                       <input type="text" name="city" class="tags-input"
   value=""
   data-options='{
   "tagClass":   "badge badge-danger r-0"
   }' >
<br>
   ...
   <br><br>
                        <div class="card mt-4">
                            ...
                            <div class="card-body text-success">
                                <button  type="button" onclick="cat(<?php echo $_SESSION['cat']; ?>)" class="btn btn-primary btn-sm">Add Filters</button>

                              
                            </div>
                            <div class="card-footer bg-transparent">
                                <button class="btn btn-primary"  id="pub" disabled="" type="submit">Publish</button>
                            </div>
                        </div>
                    </div>
                </div>
