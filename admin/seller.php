        ...
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                <ul class="nav nav-material nav-material-white responsive-tab" id="v-pills-tab" role="tablist">
                    ...
                    <li>
                        <a class="nav-link " href="buyer.php" r=""><i class="icon icon-face"></i> Buyers</a>
                    </li>
                    <li>
                        <a class="nav-link active" href="seller.php"><i class="icon  icon-local_shipping"></i> Sellers</a>
                    </li>
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                               ...
                               data-options='{ "paging": false; "searching":false}' style="margin-bottom: 0px">
                                    ...
                                    <tbody>
<?php 
                                        $sql="SELECT * from seller_buyer where seller_buyer_status=1 ";
                                    ...
                                    <tr class="">
                                        ...
                                        <td>
                                            <a href="edit_seller.php?id=<?php echo $row["id"]; ?>&name=seller_edit" class="btn-fab btn-fab-sm btn-primary shadow text-white"><i class="icon-pencil"></i></a> &nbsp; &nbsp;
                                            <a href="profile_control.php?id=<?php echo $row["id"]; ?>&name=seller_view" class="btn-fab btn-fab-sm btn-warning shadow text-white"><i class="icon-eye"></i></a>&nbsp; &nbsp;
                                            <a  class=" btn-fab btn-fab-sm btn-danger shadow text-white " href="inc/seller_del.php?id=<?php echo $row["id"]; ?>&name=seller"><i class="s-20 icon-delete_forever "></i></a> 
                                            <?php
