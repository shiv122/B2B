...
$sq="SELECT * from req_img where id='".$row['id']."' limit 1 ";
...
if (mysqli_num_rows($res) > 0)
                                            {
                                                $row1 = mysqli_fetch_assoc($res);
                                                    ...
                                                    ?>
                                    <tr>
<td><img style=" border: 1px solid #ddd; border-radius: 4px; padding: 5px; width: 150px;" src="<?php echo $row1['img']; ?>" alt=""></td>
