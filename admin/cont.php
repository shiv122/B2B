                                ...
                                <div data-toggle="collapse" data-target="#message1">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h6 class="mt-0 mb-1 font-weight-normal"> Sender : <?php echo $row['name']; ?></h6>
                                            
                                            <small>Sent : <?php echo $row['date_time']; ?></small><br>
                                            <small>Contact : <?php echo $row['phone']; ?></small><br>
                                            <small>Topic : <?php echo $row['topic']; ?></small>
