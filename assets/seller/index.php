                    ...
                    <div class="row grid">
                        <div class="col-md-5 white p-5">
                           ...
                           <div class="mb-5">
                            ...
                            <form class="form-material" action="log.php" method="POST">
                                <!-- Input -->
                                <div class="body">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input autocomplete="off" name="pass" required type="Password" id="password" class="form-control "/>
                        ...
                        <div class="pt-3 mb-5">
                            <p>For an admin adventure.</p>
                        </div>
                            <input type="submit" onclick="onC()" class="btn btn-light s-14 pl-4 pr-4 text-primary" value="Create Account">
