        ...
        <div class="container-fluid text-white">
            ...
            <div class="row">
                <ul class="nav responsive-tab nav-material nav-material-white">
                    <li>
                        <a class="nav-link active" href="panel-page-products.php"><i class="icon icon-list"></i>All Products</a>
                    </li>
                    <li>
                        <a class="nav-link" href="panel-page-products-create.php"><i
                                class="icon icon-plus-circle"></i> Add New Product</a>
                    </li>
                    <li>
                        <a class="nav-link" href="manage_product.php"><i class="icon-hourglass-3"></i> &nbsp;&nbsp;&nbsp;&nbsp;Pending product</a>
                    </li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                               ...
                               data-options='{ "paging": false; "searching":false}' style="margin-bottom: 0px">
                                    ...
                                    <tbody>
<?php 
                                        $sql="SELECT id,pro_name,pro_brand,catagory,price,sku,pro_details,tags,mod_date,product_status,image FROM product where product_status='1' ";
