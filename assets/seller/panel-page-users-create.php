        ...
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                <ul class="nav nav-material nav-material-white responsive-tab" id="v-pills-tab" role="tablist">
                    <li>
                        <a class="nav-link"  href="panel-page-users.php"><i class="icon icon-home2"></i>All Users</a>
                    </li>
                    <li>
                        <a class="nav-link active"  href="panel-page-users-create.php" ><i class="icon icon-plus-circle"></i> Add New User</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="animated fadeInUpShort">
            <div class="row my-3">
                <div class="col-md-7  offset-md-2">
                    <form action="add_user_data.php" novalidate method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="col-md-8">
                                        <div class="form-group m-0">
                                            ...
                                            <input id="name" name="name" placeholder="Enter User Name" class="form-control r-0 light s-12 " type="text">
                                        </div>
...
<input id="file-upload" name="photo" type="file"/>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-3 m-0">
                                        ...
                                        <input name="city" type="text" class="form-control r-0 light s-12" id="inputCity">
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
