...
echo $row['name'];
                        ...
                        <div class="form-group">
                            ...
                            <label for="productDetails">Aditional Info</label><br>
                            <textarea name="adl_info"  class="form-control p-t-40 editor" id="productDetails"
                                      placeholder="Write Something..." rows="17" required></textarea>
                            <div class="invalid-feedback">
                                Please provide a Aditional Info.
                            </div>
                        </div>
...
<label for="file-upload" class="custom-file-upload">
    <i class="fa fa-cloud-upload"></i>Upload Product Image</label>
<input class="col-md-6 mb-3" id="file-upload" name="photo1" type="file"/>
<label for="file-upload" class="custom-file-upload">
    <i class="fa fa-cloud-upload"></i>Upload Product Image</label>
<input class="col-md-6 mb-3" id="file-upload" name="photo2" type="file"/>
<label for="file-upload" class="custom-file-upload">
    <i class="fa fa-cloud-upload"></i>Upload Product Image</label>
<input class="col-md-6 mb-3" id="file-upload" name="photo3" type="file"/>
<label for="file-upload" class="custom-file-upload">
    <i class="fa fa-cloud-upload"></i>Upload Product Image
<input class="col-md-6 mb-3" id="file-upload" name="photo4" type="file"/>
</label>
<br>
